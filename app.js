/*
* @Author: 1084147381@qq.com
* @Date:   2018-07-10 15:53:56
* @Last Modified by:   1084147381@qq.com
* @Last Modified time: 2018-07-10 17:01:07
*/
// 创建app应用模块
var yike = angular.module("app",[]);
yike.run(["$rootScope",function($rootScope){
// 给头部a标签绑定事件,点击可以实现侧边导航的显示或隐藏
// 给collapse类定义值,通过这个决定collapse是否有效
